resource "azurerm_application_gateway_backend_address_pool" "as_backend_address_pool" {
...
resource "azurerm_virtual_machine_scale_set" "vm_scale_set" {
  ...
  network_profile {
    ...
    ip_configuration {
      ...
      application_gateway_backend_address_pool_ids = [azurerm_application_gateway_backend_address_pool.as_backend_address_pool.id]
    }
  }
